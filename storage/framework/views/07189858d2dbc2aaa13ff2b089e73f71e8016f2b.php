                        ...
                        <div class="col-md-12"><?php echo $__env->make('backend.shared.flash-message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                              <div class="col-md-12">
                                    ...
                                    <div class=" form-group row m-t-20">
                                     ...
                                     <input type="hidden" value="<?php echo e($img_cv = $tourguide->img_cv); ?>">
                                     <input type="hidden" value="<?php echo e($img_cd = $tourguide->img_cd); ?>">
                                     <input type="hidden" value="<?php echo e($img_full = $tourguide->img_full); ?>">
                                     <div class="row">
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-1" src="<?php echo e(asset("images/cv/$img_cv")); ?>" title="Preview Logo">
                                                  </div>
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-2" src="<?php echo e(asset("images/cd/$img_cd")); ?>" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-3" src="<?php echo e(asset("images/full/$img_full")); ?>" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
