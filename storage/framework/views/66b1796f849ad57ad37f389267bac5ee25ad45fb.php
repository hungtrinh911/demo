      ...
      <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo e(action('Backend\TourGuideController@index')); ?>">TourGuide</a></li>
           <li class="breadcrumb-item"><a href="<?php echo e(action('Backend\CommentController@showComment',['id'=>$ids])); ?>">Comment</a></li>
      ...
      <!-- STAT -->
          ...
          <div class="app-ticket app-ticket-details">
            <div class="card-box">
              ...
              <hr>
                 <form enctype= "multipart/form-data"  method="post" class="form-add" action="<?php echo e(action('Backend\CommentController@showEditCommentForm',['id' => $id_cmt ])); ?>" >
