        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\TranningCourseController@showAddForm')); ?>" class="btn btn-default">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\TranningCourseController@index')); ?>">Tin tức</a></li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-url="<?php echo e(action('Api\TranningCourseController@grid')); ?>"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('submit', function () {
                ...
                $.ajax({
                    url: '<?php echo e(action('Api\TranningCourseController@delete')); ?>', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
        ...
        function gridAction(value, row) {
            ...
            <?php if(Auth::user()->can('edit-news')): ?>
                actions += '<a href="<?php echo e(action('Backend\TranningCourseController@showEditForm', array('id'=>''))); ?>/' + row.id + '" class="on-default edit-row text-primary"><i class="fa fa-pencil"></i></a> ';
            // <?php endif; ?>
            //         <?php if(Auth::user()->can('delete-news')): ?>
            ...
            // <?php endif; ?> 
            <?php if(Auth::user()->can('delete-news')): ?>
                actions += '<a href="<?php echo e(action('Backend\TranningCourseController@destroy', array('id'=>''))); ?>/' + row.id +'"class=on-default "><i class="fa fa-trash-o"></i></a> ';
            <?php endif; ?>
                return actions;
        }
    </script>
