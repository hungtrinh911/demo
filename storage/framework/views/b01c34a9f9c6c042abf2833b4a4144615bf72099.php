<?php $__env->startSection('title', 'Chuyên mục JobSearch'); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\JobSearchController@category')); ?>" class="btn btn-default">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\JobSearchController@index')); ?>">JobSearch</a></li>
            ...
            <div class="col-lg-4 col-form">
                <div class="card-box">
                    ...
                    <form method="post" class="form-add d-none"
                          action="<?php echo e(action('Backend\JobSearchController@addCategory')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\NewsCategory::treeJobSearch('', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\NewsCategory::orphanListJobSearch(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <form method="post" class="form-edit d-none"
                          action="<?php echo e(action('Backend\JobSearchController@editCategory', array('id', $term->id))); ?>">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                    data-style="btn-white">
                                <?php $__currentLoopData = \App\NewsCategory::tree('', true, '---', request()->route('id')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    data-style="btn-white">
                                <option value="0">----------</option>
                                <?php $__currentLoopData = \App\NewsCategory::orphanList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
            ...
            <div class="col-lg-8 col-grid">
                <div class="card-box">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__currentLoopData = \App\NewsCategory::treeJobSearch('', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <?php if(Auth::user()->can('edit-news_category')): ?>
                                        <a href="<?php echo e(action('Backend\JobSearchController@showEditCategoryForm', array('id'=>$item->id))); ?>"
                                    ...
                                    <?php if(Auth::user()->can('delete-news_category')): ?>
                                        <a href="javascript:;"
                                           ...
                                           data-href="<?php echo e(action('Backend\JobSearchController@deleteCategory', array('id'=>$item->id))); ?>">
