<?php $__env->startSection('title', 'Thêm JobSeach'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Thêm JobSeach</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\JobSeachController@index')); ?>">JobSeach</a></li>
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\JobSeachController@add')); ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    <?php $__currentLoopData = \App\News::orphanListJobSeach(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
