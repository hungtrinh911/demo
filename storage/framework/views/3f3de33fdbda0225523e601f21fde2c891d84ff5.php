...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset("backend/assets/css/login/bootstrap.min.css")); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset("backend/assets/css/login/icons.css")); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset("backend/assets/css/login/style.css")); ?>"/>
...
<div class="wrapper-page">
    <div class="card-box">
        ...
        <div class="p-20">
            <form method="POST" class="form-horizontal m-t-20" action="<?php echo e(action('Backend\AuthController@login')); ?>">
                <!-- @csrf  -->
                ...
                <div class="form-group-custom">
                    <input type="text" id="usernameOrEmail" name="usernameOrEmail" value="<?php echo e(old('usernameOrEmail')); ?>"
                           required="required"/>
