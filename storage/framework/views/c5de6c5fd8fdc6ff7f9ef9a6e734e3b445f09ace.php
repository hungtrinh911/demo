<?php $__env->startSection('title', 'Thêm Training Course'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Thêm TrainingCourse</h4>
                <ol class="breadcrumb">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\TrainingCourseController@add')); ?>">
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\News::orphanListTrainingCourse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
