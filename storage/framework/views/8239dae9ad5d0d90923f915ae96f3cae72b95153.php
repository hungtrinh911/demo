          ...
          <div class="col-xl-8 offset-xl-2">
            <form class="d-flex justify-content-between align-items-center" id="serch-form" method="post"
              ...
              <div class="input-form">
                <input class="form-control" type="text" placeholder="<?php echo e($multilang->search); ?>..." id="key_word" name="key_word" />
              </div>
              <div class="select-provincial">
                <select class="form-control js-provincial-single " name="provincial">
                  <option value=""><?php echo e($multilang->selectlocale); ?></option>
              ...
              <div class="select-language">
                ...
                <option value=""><?php echo e($multilang->selectlang); ?></option>
      ...
      <div class="row">
        <div class="col-xl-10 offset-xl-1">
          <div class="tour-guider d-flex justify-content-between align-items-center">
            ...
            <div class="item"><img class="img-fluid" src="<?php echo e(asset("images/cv/$img_cv")); ?>"alt=""/>
  ...
  <div class="container">
    <div class="list-tourguide-wrap">
      <div class="row">
        <div class="col-xl-6 offset-xl-3">
          <div class="tourguide-title">
            <h2><?php echo e($multilang->searchresult); ?></h2>
            <hr>
          </div>
        </div>
      </div>
      <div class="row">
         <div class="col-xl-10 offset-xl-1">
            ...
            <?php if(array_filter($tourguide_searched)): ?>
              <?php $__currentLoopData = $tourguide_searched; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
