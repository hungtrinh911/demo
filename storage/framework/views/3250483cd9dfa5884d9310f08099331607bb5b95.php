                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row">
                           <div class="col-md-12"><?php echo $__env->make('backend.shared.flash-message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                              <div class="col-md-12">
                                    <form enctype= "multipart/form-data"  method="post" class="form-add" action="<?php echo e(action('Backend\TourGuideController@create')); ?>" >
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="col-9 m-t-15"> 
                                              <label class="radio-inline">
                                                <input type="radio" name="sex" id="0" value="0">Nam
                                              </label>
                                              <label class="radio-inline">
                                                <input type="radio" name="sex" id="1" value="1">Nữ
                                              </label>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                      ...
                                      <div class="col-md-5">
                                          <div class="form-group row">
                                             ...
                                             <div class="input-group col-9 ">
                                                  <input type="text" class="form-control" placeholder="mm/dd/yyyy" name="dob" id="datepicker-autoclose" value="<?php echo e(old('dob')); ?>">
                                          ...
                                          <div class="form-group row">
                                                  ...
                                                  <div class="col-9 m-t-15">
                                                      ...
                                                      <input type="radio" name="status"  value="0">Tạm dừng
                                                  </div>
                                          </div>
                                          ...
                                          <div class=" form-group row m-t-20">
                                            ...
                                            data-style="btn-white">
                                              <?php $__currentLoopData = \App\TourGuide::orphanList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <div class="clearfix"></div>
                                     ...
                                     <div class="row">
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-1" src="<?php echo e(asset("backend/assets/images/profile.png")); ?>" title="Preview Logo">
                                                  </div>
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-2" src="<?php echo e(asset("backend/assets/images/profile.png")); ?>" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-3" src="<?php echo e(asset("backend/assets/images/profile.png")); ?>" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                       ...
                                       <div class="col-md-5">
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                  <input type="text" class="form-control" id="phone" name="phone" placeholder="" value="<?php echo e(old('phone')); ?>" />
                                                </div></label>
                                            </div>
                                     ...
                                     <div class="col-md-5">
                                      <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                              <input type="text" class="form-control" id="passpost" name="passpost" value="<?php echo e(old('passpost')); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                               <input type="email" class="form-control" id="email" name="email" required 
                                                     parsley-type="email" placeholder="Enter a valid e-mail" value="<?php echo e(old('email')); ?>" />
                                            </div>
                                        </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-10">
                                            ...
                                            <label for="" >Địa điểm chi tiết<span class="text-danger"></span></label>
                                                <textarea  class="form-control" id="address" name="address" value="<?php echo e(old('address')); ?>"></textarea>
                                            </div>
                                          </div>
                                     </div>
                                     <div class="row">
                                         <div class="col-md-5">
                                          <div class="form-group row">
                                            <label for="" class="col-3 col-form-label">Loại Thẻ<span class="text-danger"></span></label>
                                            <div class="col-9">
                                               <input type="text" class="form-control" id="LicensedType" name="LicensedType" value="<?php echo e(old('LicensedType')); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                               <input type="text" class="form-control" id="card_id" name="card_id" value="<?php echo e(old('card_id')); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                         ...
                                         <div class="col-md-5">
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <select name="class" id="class" class="selectpicker form-control">
                                                     <option ><?php echo e($multilang->distinguished); ?></option>
                                                     <option ><?php echo e($multilang->master); ?></option>
                                                     <option ><?php echo e($multilang->licensed); ?></option>
                                                     <option ><?php echo e($multilang->mate); ?></option>
                                                 </select>
                                                 </div>
                                             </div>
                                        <div class="form-group row">
