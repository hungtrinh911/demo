        ...
        <!-- Page-Title -->
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">Tùy chỉnh thông tin <?php echo e((session('locale'))); ?></h4>
                    <ol class="breadcrumb">
                    ...
                    <div class="tab-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="site_multi_address" name="site_multi_address"
                                               value="<?php echo e($option->site_multi_address); ?>"
                                                class="form-control
                        ...
                        <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <?php for($i=0; $i < count($slides_top) ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+5); ?>">
                                    <input type="hidden" value="<?php echo e($k = $j+5); ?>">
                                    <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                    <tr>
                                    <td><label for=""></label><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                     value="<?php echo e($slides_top[$i]->title); ?>" placeholder="tiêu đề"></td>
                                    <td><label for=""></label>
                                    <textarea id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control"><?php echo e($slides_top[$i]->content); ?></textarea>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                                <button type="button" id="btn-select-site-image"
                                                        class="btn btn-default waves-effect waves-light w-100"
                                                        data-toggle="modal" data-target="#<?php echo e($m); ?>">
                                                    Chọn
                                                </button>
                                            </div>
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($slides_top[$i]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
                                                 aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog modal-full">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <iframe style="width:100%;" height="500px" frameborder="0"
                                                                    src="/backend/plugins/filemanager/dialog.php?type=1&field_id=<?php echo e($k); ?>&relative_url=1&multiple=0">
                                                            </iframe>
                                                        </div>
                                                    </div><!-- /.modal-content -->
                                                </div><!-- /.modal-dialog -->
                                    ...
                                    <input type="hidden" value="<?php echo e($k = $j+5); ?>">
                                    <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                    <input type="hidden" value="<?php echo e($f = $i-20); ?>">
                                    <tr>
                                    <td><label for=""></label><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                     value="<?php echo e($site_tourguides[$f]->title); ?>" placeholder="tiêu đề"></td>
                                     
                                    <td><label for=""></label>
                                    <textarea id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control"><?php echo e($site_tourguides[$f]->content); ?></textarea>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                                <button type="button" id="btn-select-site-image"
                                            ...
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($site_tourguides[$f]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
                                     ...
                                     <?php for($i = 40 ; $i< 44 ;$i++): ?>
                                     <input type="hidden" value="<?php echo e($j = $i-39); ?>">
                                     <tr>
                                          <label for=""></label>
                                          <td>Nội dung</td> 
                                          <label for=""></label>
                                          <td><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                          value="<?php echo e($site_guide_profiles[$j]); ?>" placeholder="tiêu đề">
                                          </td>
                                          <td></td>
                                     </tr>
                                     <?php endfor; ?>

                                    <?php for($i = 1000 ; $i< 1001 ;$i++): ?>
                                     <input type="hidden" value="<?php echo e($j = $i-1000); ?>">
                                     <input type="hidden" value="<?php echo e($k = $i+5); ?>">
                                     <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                     <tr>
                                        <td>Ảnh nền</td>
                                            <td>
                                            <div class="row h-100">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                           value="<?php echo e($site_guide_profiles[$j]); ?>">
                                                </div>
                                                <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                     role="dialog"
                                                     aria-labelledby="full-width-modalLabel"
                                    ...
                                    <?php for($i = 3000; $i < 3001 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+5); ?>">
                                    <input type="hidden" value="<?php echo e($k = $j+5); ?>">
                                    <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                    <input type="hidden" value="<?php echo e($f = $i-3000); ?>">
                                    <tr>
                                    <td><label for=""></label><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                     value="<?php echo e($site_job_search[$f]->description); ?>" placeholder="tiêu đề"></td>

                                    <td><label for=""></label>
                                    <textarea id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control"><?php echo e($site_job_search[$f]->content); ?></textarea>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                                <button type="button" id="btn-select-site-image"
                                            ...
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($site_job_search[$f]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
                                    ...
                                    <?php for($i = 5000; $i < 5003 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+5); ?>">
                                    <input type="hidden" value="<?php echo e($f = $i-5000); ?>">
                                    <tr>
                                        <td><label for=""></label><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                         value="<?php echo e($site_number[$f]->number); ?>"></td>
                                        <td><label for=""></label>
                                        <input type="text" id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control" value="<?php echo e($site_number[$f]->word); ?>">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <?php endfor; ?>
                                    ...
                                    <?php for($i = 4000; $i < 4003 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+5); ?>">
                                    <input type="hidden" value="<?php echo e($f = $i-4000); ?>">
                                    <tr>
                                        <td><label for=""></label><input type="text" id="<?php echo e($i); ?>" name="<?php echo e($i); ?>" class="form-control"
                                         value="<?php echo e($site_faqs[$f]->title); ?>" placeholder="tiêu đề"></td>
                                        <td>
                                        <textarea id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control"><?php echo e($site_faqs[$f]->content); ?></textarea>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <?php endfor; ?>
                                    ...
                                    <?php for($i = 6000; $i < 6001 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+5); ?>">
                                    <input type="hidden" value="<?php echo e($f = $i-6000); ?>">
                                    <tr>
                                        <td><label for=""></label><input type="text" id="9003" name="9003" class="form-control"
                                         value="<?php echo e($site_contact_us[0]); ?>" placeholder="tiêu đề"></td>
                                        <td>
                                        <textarea id="9004" name="9004" class="form-control"><?php echo e($site_contact_us[1]); ?></textarea>
                                        </td>
                                    </tr>
                                    <?php endfor; ?>
                                    <tr>
                                        <td><label for=""></label><input type="text" id="9000" name="9000" class="form-control"
                                         value="<?php echo e($site_contact_us[2]); ?>" placeholder="tiêu đề"></td>
                                       
                                        <td><label for=""></label><input type="text" id="9001" name="9001" class="form-control"
                                         value="<?php echo e($site_contact_us[3]); ?>" placeholder="tiêu đề"></td>
                                     
                                        <td><label for=""></label><input type="text" id="9002" name="9002" class="form-control"
                                         value="<?php echo e($site_contact_us[4]); ?>" placeholder="tiêu đề"></td>
                        ...
                        <div class="tab-pane" id="trainingcourse">
                            <table class="table table-bordered table-striped">
                                <tbody>
                                <tr>
                                     <?php for($i = 300 ; $i< 301 ;$i++): ?>
                                     <input type="hidden" value="<?php echo e($j = $i-300); ?>">
                                     <input type="hidden" value="<?php echo e($k = $i+5); ?>">
                                     <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                     <tr>
                                        <td width="35%">Ảnh 1</td>
                                            ...
                                            <div class="row h-100">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                           value="<?php echo e($tc_banner1[$j]->image); ?>">
                                                </div>
                                                <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                     role="dialog"
                                                     aria-labelledby="full-width-modalLabel"
                                ...
                                <tr>
                                   ...
                                   <?php for($i = 330 ; $i< 331 ;$i++): ?>
                                     <input type="hidden" value="<?php echo e($j = $i-330); ?>">
                                     <input type="hidden" value="<?php echo e($k = $i+5); ?>">
                                     <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                     <tr>
                                        <td>Ảnh 2</td>
                                            ...
                                            <div class="row h-100">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                           value="<?php echo e($tc_banner2[$j]->image); ?>">
                                                </div>
                                                <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                     role="dialog"
                                                     aria-labelledby="full-width-modalLabel"
                                ...
                                <tr>
                                    ...
                                    <?php for($i = 360 ; $i< 361 ;$i++): ?>
                                     <input type="hidden" value="<?php echo e($j = $i-360); ?>">
                                     <input type="hidden" value="<?php echo e($k = $i+5); ?>">
                                     <input type="hidden" value="<?php echo e($m = $k+5); ?>">
                                     <tr>
                                        <td>Ảnh 3</td>
                                            ...
                                            <div class="row h-100">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                           value="<?php echo e($tc_banner3[$j]->image); ?>">
                                                </div>
                                                <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                     role="dialog"
                                                     aria-labelledby="full-width-modalLabel"
                                 ...
                                 <tr> 
                                    ...
                                    <?php for($i=0; $i < count($site_review) ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($j = $i+695); ?>">
                                    <input type="hidden" value="<?php echo e($l = $i+700); ?>">
                                    <input type="hidden" value="<?php echo e($k = $i+705); ?>">
                                    <input type="hidden" value="<?php echo e($m = $i+710); ?>">
                                    <tr>
                                    <td><label for=""></label><input type="text" id="<?php echo e($j); ?>" name="<?php echo e($j); ?>" class="form-control"
                                     value="<?php echo e($site_review[$i]->title); ?>" placeholder="tiêu đề"></td>
                                    <td><label for=""></label>
                                    <textarea id="<?php echo e($l); ?>" name="<?php echo e($l); ?>" class="form-control"><?php echo e($site_review[$i]->content); ?></textarea>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                                <button type="button" id="btn-select-site-image"
                                            ...
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($site_review[$i]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
                        ...
                        <div class="tab-pane" id="travelblog">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr> 
                                    ...
                                    <?php for($i=0; $i < 1 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($k = $i+3610); ?>">
                                    <input type="hidden" value="<?php echo e($m = $i+3615); ?>">
                                    <tr>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($tb_banner[$i]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
                        ...
                        <div class="tab-pane" id="jobsearch">
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    ...
                                    <?php for($i=0; $i < 1 ; $i++): ?> 
                                    <input type="hidden" value="<?php echo e($k = $i+2620); ?>">
                                    <input type="hidden" value="<?php echo e($m = $i+2625); ?>">
                                    <tr>
                                    <td>
                                        <div class="row h-100">
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="hidden" id="<?php echo e($k); ?>" name="<?php echo e($k); ?>"
                                                       value="<?php echo e($js_banner[$i]->image); ?>">
                                            </div>
                                            <div id="<?php echo e($m); ?>" class="modal fade" tabindex="-1"
                                                 role="dialog"
                                                 aria-labelledby="full-width-modalLabel"
