        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\TrainingCourseController@showAddForm')); ?>" class="btn btn-default">
                        <i class="fa fa-plus"></i></a>
                </div>
                <h4 class="page-title">Danh sách</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\TrainingCourseController@index')); ?>">Training Course</a></li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-url="<?php echo e(action('Api\TrainingCourseController@grid')); ?>"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('submit', function () {
                ...
                $.ajax({
                    url: '<?php echo e(action('Api\TrainingCourseController@delete')); ?>', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
        ...
        function gridAction(value, row) {
            var actions = '';
            <?php if(Auth::user()->can('edit-trainingcourse')): ?>
                actions += '<a href="<?php echo e(action('Backend\TrainingCourseController@showEditForm', array('id'=>''))); ?>/' + row.id + '" class="on-default edit-row text-primary"><i class="fa fa-pencil"></i></a> ';
             <?php endif; ?>
      
             <?php if(Auth::user()->can('delete-trainingcourse')): ?>
                actions += '<a href="javascript:;" class="on-default remove-row text-danger grid-btn-delete" data-placement="top" title="" data-original-title="Delete" data-toggle="modal" data-target=".modal-delete" data-href="<?php echo e(action('Backend\TrainingCourseController@destroy', array('id'=>''))); ?>/' + row.id + '" class="on-default edit-row text-primary"><i data-id="' + row.id + '" class="fa fa-trash-o grid-btn-delete"></i></a> ';
            <?php endif; ?>
                return actions;
        }
    </script>
