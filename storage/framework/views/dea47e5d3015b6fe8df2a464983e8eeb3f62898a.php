<?php $__env->startSection('title', 'Danh sách Trang đơn'); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\PageController@showAddForm')); ?>" class="btn btn-default">
                        <i class="fa fa-plus"></i></a>
                </div>

                <h4 class="page-title">Danh sách Trang đơn</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\PageController@index')); ?>">Trang đơn</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <?php if(Auth::user()->can('delete-page')): ?>
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-url="<?php echo e(action('Api\PageController@grid')); ?>"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('submit', function () {
                ...
                $.ajax({
                    url: '<?php echo e(action('Api\PageController@delete')); ?>', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
        ...
        function gridAction(value, row) {
            var actions = '';
            <?php if(Auth::user()->can('edit-page')): ?>
                actions += '<a href="<?php echo e(action('Backend\PageController@showEditForm', array('id'=>''))); ?>/' + row.id + '" class="on-default edit-row text-primary"><i class="fa fa-pencil"></i></a> ';
            <?php endif; ?>
                    <?php if(Auth::user()->can('delete-page')): ?>
