...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\TranningCourseController@edit', array('id'=>$thing->id))); ?>">
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\News::orphanList($thing->locale); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: '<?php echo e(action('Api\TranningCourseController@treeCategory')); ?>', type: 'GET', dataType: 'JSON',
