               ...
               <!--  <div class="btn-group pull-right m-t-15">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\PermissionController@index')); ?>">Permission</a></li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="table" class="table-bordered "
                           ...
                           data-url="<?php echo e(action('Api\PermissionController@grid')); ?>"
    ...
    <script>
        ...
        function gridAction(value, row) {
            ...
            <?php if(Auth::user()->can('edit-news')): ?>
                actions += '<a href="<?php echo e(action('Backend\NewsController@showEditForm', array('id'=>''))); ?>/' + row.id + '" class="on-default edit-row text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil"></i></a> ';
            <?php endif; ?>
