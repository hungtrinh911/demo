          ...
          <div class="collapse-body">
            <div class="job-skill-content">
              <ul class="list-unstyled">
                ...
                <?php if($morecre != null): ?>
                  <?php $__currentLoopData = $morecre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $morecr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <li><?php echo e($morecr); ?></li>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
              </ul>
            </div>
          ...
          <div class="collapse-body">
            <div class="job-skill-content">
              <ul class="list-unstyled">
               ...
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php if($morelanguages != null): ?>
                <?php $__currentLoopData = $morelanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $morelang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li><?php echo e($morelang); ?></li>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php endif; ?>
              </ul>
            </div>
              ...
              <div class="collapse-body">
                <div class="share-thinking-content" id="divVote">
                  ...
                  <ul class="list-unstyled share-rate">
                    <li>
                      <p><?php echo e($multilang->friendly); ?></p>
                      <div id="half1" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(0,$id)); ?>"></div>
                    </li>
                    <li>
                      <p><?php echo e($multilang->foreignlanguage); ?></p>
                      <div id="half2" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(1,$id)); ?>"></div>
                   </p>
                    </li>
                    <li>
                      <p><?php echo e($multilang->work); ?></p>
                      <div id="half3" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(2,$id)); ?>"></div>
                   </p>
                    </li>
                    <li>
                      <p><?php echo e($multilang->facial); ?></p>
                      <div id="half4" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(3,$id)); ?>"></div>
                    </p>
                    </li>
                    <li>
                      <p><?php echo e($multilang->knowledge); ?></p>
                      <div id="half5" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(4,$id)); ?>"></div>
                   </p>
                    </li>
                    <li>
                      <p><?php echo e($multilang->ability); ?></p>
                      <div id="half6" class="half" data-score="<?php echo e(\App\TourGuide::getPoint(5,$id)); ?>"></div>
              ...
              <div class="collapse-body">
                <div class="tour-location-content">
                   <div class="select-location">
                    <p class="label-name"><?php echo e($multilang->locale_1); ?></p>
                    <select class="form-control js-location select2-hidden-accessible" name="location">
                     <?php $__currentLoopData = $locale_1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="select-location">
                   <p class="label-name"><?php echo e($multilang->locale_2); ?></p>
                    <select class="form-control js-location select2-hidden-accessible" name="location">
                     <?php $__currentLoopData = $locale_2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value=""><?php echo e($item); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
              ...
              <div class="collapse-body">
                <div class="comment-box-content">
                  <div class="cmt-list">
                    ...
                    <div class="item">
                      <div class="avatar" style="background-image: url('<?php echo e(asset("fontend/images/avata.png")); ?>');"></div>
                     <div class="info">
