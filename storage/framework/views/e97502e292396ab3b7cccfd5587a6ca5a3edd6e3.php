...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\BlogController@index')); ?>">Blog</a></li>
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\BlogController@add')); ?>">
            @csrf
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\Blog::orphanList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
