<?php $__env->startSection('title', 'Thêm JobSearch'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Thêm JobSearch</h4>
                <ol class="breadcrumb">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\JobSearchController@add')); ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    <?php $__currentLoopData = \App\News::orphanListJobSearch(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
