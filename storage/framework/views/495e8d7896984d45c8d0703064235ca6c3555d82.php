...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\NewsController@add')); ?>">
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\News::orphanList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
