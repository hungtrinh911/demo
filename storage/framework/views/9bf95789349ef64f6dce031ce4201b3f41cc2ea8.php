     ...
     <div class="profile-sidebar">
        <!-- PORTLET MAIN -->
                ...
                <div class="profile-userpic">
                  <img  src="<?php echo e(asset("images/cv/$img_cv")); ?>" class="rounded-circle" alt="<?php echo e($tourguides->name); ?>">
                </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="checkbox checkbox-primary">
                            <input id="<?php echo e($lang1->id+100); ?>" class="lang" type="checkbox" name="languages[]" value="<?php echo e($lang1->id); ?>"  >
                            <label for="<?php echo e($lang1->id+100); ?>">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="checkbox checkbox-primary">
                          <input id="<?php echo e($lang2->id+100); ?>" class="lang" type="checkbox" name="languages[]" value="<?php echo e($lang2->id); ?>"  >
                          <label for="<?php echo e($lang2->id+100); ?>">
                 ...
                 <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Khác</label>
                      <div>
                        <textarea  class="form-control" id="langu" name="langu"><?php echo e($tourguides->languages); ?></textarea>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class=" card-box">
                     <div class="form-group">
                      ...
                      <?php $__currentLoopData = $tourguide_role1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <div class="checkbox checkbox-primary">
                              <input id="<?php echo e($role1->id +200); ?>" class="role" type="checkbox" name="roles[]" value="<?php echo e($role1->id); ?>"  >
                                <label for="<?php echo e($role1->id +200); ?>">
                      ...
                      <?php $__currentLoopData = $tourguide_role2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <div class="checkbox checkbox-primary">
                              <input id="<?php echo e($role2->id +200); ?>" class="role" type="checkbox" name="roles[]" value="<?php echo e($role2->id); ?>"  >
                                <label for="<?php echo e($role2->id +200); ?>">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                          <?php for($i=0; $i < count($tourguide_fieldname) ; $i++): ?> 
                                           <tr class="text-left">
                                              <td class="text-left"><?php echo e($tourguide_fieldname[$i]); ?></td>
                                          <?php for($j=0; $j < 5 ; $j++): ?> 
                                              <td class="text-center">
                                                <div class="" style="position: relative;">
                                                  <input id="<?php echo e($tourguide_all_field[$i][$j]->id+500); ?>" class="field" type="checkbox" name="field[]" value="<?php echo e($tourguide_all_field[$i][$j]->id); ?>"  >
                                                </div>
                                              </td>
                                          <?php endfor; ?>
                                            </tr>   
             ...
             <!-- end -->
                     ...
                     <div class="form-group js-lang-check" id="js-lang-check">
                      ...
                      <?php $__currentLoopData = $tourguide_certificate1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <div class="checkbox checkbox-primary">
                              <input id="<?php echo e($certificate1->id +300); ?>" class="certificate" type="checkbox" name="certificates[]" value="<?php echo e($certificate1->id); ?>"  >
                                <label for="<?php echo e($certificate1->id +300); ?>">
                      ...
                      <?php $__currentLoopData = $tourguide_certificate2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <div class="checkbox checkbox-primary">
                              <input id="<?php echo e($certificate2->id +300); ?>" class="certificate" type="checkbox" name="certificates[]" value="<?php echo e($certificate2->id); ?>"  >
                                <label for="<?php echo e($certificate2->id +300); ?>">
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                            <label >Khác</label>
                            <div>
                            <textarea  class="form-control" id="certi" name="certi"><?php echo e($tourguides->certificate); ?></textarea>
                            </div>
                          </div>
                      </div>
                        <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div>
                                    <div class="input-daterange input-group" id="date-range">
                                        <input type="text" class="form-control" name="start" id="start" value="<?php echo e($tourguides->start); ?>" />
                                        <input type="text" class="form-control" name="end"  id="end" value="<?php echo e($tourguides->end); ?>" />
                                    </div>
                                  </div>
                              </div>  
                               <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr style="padding:10px 0 2px 0;">
                             <textarea name="locale_1" class="form-control" placeholder="Các địa điểm cách nhau bởi dấu chấm phẩy "><?php echo e($tourguides->locale_1); ?></textarea>
                          </div>
                            <div class="form-group">
                               <div>
                                     <button type="submit" class="btn btn-primary waves-effect waves-light" name="btn_role">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr>
                           <textarea name="locale_2" class="form-control"  placeholder="Các địa điểm cách nhau bởi dấu chấm phẩy "><?php echo e($tourguides->locale_2); ?></textarea>
                          </div>
                        </div> 
                     </div>
