<?php $__env->startSection('title', 'Sua quyền'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add" action="<?php echo e(action('Backend\RoleController@edit', array('id'=>$role->id))); ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-form">
                    <div class="card-box">
                        <input type="hidden" id="id" name="id" value="<?php echo e($role->id); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" parsley-trigger="change" required
                                   placeholder="" class="form-control" value="<?php echo e($role->name); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="slug" name="slug" parsley-trigger="change" required
                                   placeholder="" class="form-control" value="<?php echo e($role->slug); ?>">
                        </div>
                                ...
                                <?php $__currentLoopData = \App\Permission::getAll(true,0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li role="treeitem" aria-selected="false" aria-level="1"
                                        ...
                                        <ul role="group" class="jschildren">
                                            <?php ($childPermissions = \App\Permission::getAll(false,$item->thing_id)); ?>
    ...
    <script type="text/javascript">
        ...
        $("#checkTree")
            .bind("loaded.jstree", function (event, data) {
                // alert("loaded");
                // $("#categoryTree").jstree("select_node", _selectedCategoryNode);
                <?php $__currentLoopData = $jstreePermission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
