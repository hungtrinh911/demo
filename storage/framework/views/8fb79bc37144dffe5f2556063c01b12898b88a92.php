     ...
     <!--  <link href="backend/plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
      ...
      <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="<?php echo e(action('Backend\FaqsController@showFaqs')); ?>">Faqs</a></li>
          <li class="breadcrumb-item active">Sửa Faqs</li>
        </ul>
        <div style="display: none;">  <?php echo e($ids = $faqs->id); ?></div>
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card-box">
              ...
              <hr>
                 ...
                 <form enctype= "multipart/form-data"  method="post" class="form-add" action="<?php echo e(action('Backend\FaqsController@showEditFaqsForm',['id' => $ids ])); ?>" >
                                   ...
                                   <div class="col-md-10 row">
                                    ...
                                    <div class="col-md-5">
                                      <div class=" form-group row m-t-20">
                                        ...
                                        <?php $__currentLoopData = \App\FormSubmission::orphanListEdit($faqs_locale->locale,true,'faqs',$faq->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <div class="row">
                                      <div class="col-md-10">
                                             <div class="form-group">
                                              <label>Câu hỏi</label>
                                              <div>
                                                <textarea  class="form-control" id="question" name="question"><?php echo e($faqs->question); ?></textarea>
                                              </div>
                                            </div>
                                      </div>
                                      ...
                                      <div class="col-md-10">
                                           <div class="form-group">
                                            <label>Trả lời</label>
                                            <div>
                                              <textarea  class="form-control" id="answer" name="answer"><?php echo e($faqs->answer); ?></textarea>
                                            </div>
                                          </div>
                                        </div>  
                                    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('form').parsley();
     var status = "<?php echo e($faqs->status); ?>";
