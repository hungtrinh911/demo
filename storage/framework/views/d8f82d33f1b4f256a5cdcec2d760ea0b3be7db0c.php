<?php $__env->startSection('title', 'Cập nhật JobSeach'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Cập nhật JobSeach</h4>
                <ol class="breadcrumb">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\JobSearchController@edit', array('id'=>$thing->id))); ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    <?php $__currentLoopData = \App\News::orphanListJobSearchEdit($thing->locale,true,'jobsearch',$thing->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-6">
                                <label for="tags">Thành phố</label>
                                 <div class="form-group" id="tags">
                                           <select class="selectpicker show-tick"
                                        data-style="btn-white" name="tags_place" id="tags_place">
                                                    <option value="<?php echo e($thing->tags_place); ?>" class=""><?php echo e($thing->tags_place); ?></option>
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" id="hot" name="hot" data-plugin="switchery"
                                   data-color="#f05050" data-size="small"
                                   <?php if($thing->hot == '1'): ?> checked <?php endif; ?>/>
                        </div>
