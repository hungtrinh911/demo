...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\JobSeachController@edit', array('id'=>$thing->id))); ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    <?php $__currentLoopData = \App\News::orphanListJobSeach($thing->locale); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: '<?php echo e(action('Api\JobSeachController@treeCategory')); ?>', type: 'GET', dataType: 'JSON',
