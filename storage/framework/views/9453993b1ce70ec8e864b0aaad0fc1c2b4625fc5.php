<?php $__env->startSection('title', 'Thêm Tranning Course'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h4 class="page-title">Thêm TranningCourse</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\TranningCourseController@index')); ?>">TranningCourse</a></li>
        ...
        <form method="post" class="form-add"
              action="<?php echo e(action('Backend\TranningCourseController@add')); ?>">
             <?php echo e(csrf_field()); ?>

            <input type="hidden" id="categories" name="categories" value="<?php echo e(old('categories')); ?>">
            <div class="row">
                <div class="col-lg-10">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <textarea id="excerpt" name="excerpt" class="form-control" rows="3"
                                          placeholder="Tóm tắt"><?php echo e(old('excerpt')); ?></textarea>
                            </div>
                                ...
                                <div class="row h-100">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="hidden" id="featured_img" name="featured_img"
                                               value="<?php echo e(old('featured_img')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\News::orphanListTranningCourse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: '<?php echo e(action('Api\NewsController@treeCategory')); ?>', type: 'GET', dataType: 'JSON',
                data: {},
