<?php $__env->startSection('title', 'Chuyên mục Dự án'); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\ProjectController@category')); ?>" class="btn btn-default">
                        <i class="fa fa-plus"></i></a>
                </div>

                <h4 class="page-title">Chuyên mục Dự án</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\ProjectController@index')); ?>">Dự án</a></li>
            ...
            <div class="col-lg-4 col-form">
                <div class="card-box">
                    ...
                    <form method="post" class="form-add d-none"
                          action="<?php echo e(action('Backend\ProjectController@addCategory')); ?>">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\ProjectCategory::tree('', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\ProjectCategory::orphanList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <form method="post" class="form-edit d-none"
                          action="<?php echo e(action('Backend\ProjectController@editCategory', array('id', $term->id))); ?>">
                        @csrf
                        <input type="hidden" id="id" name="id" value="<?php echo e($term->id); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                    data-style="btn-white">
                                <?php $__currentLoopData = \App\ProjectCategory::tree('', true, '---', request()->route('id')); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-8 col-grid">
                <div class="card-box">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__currentLoopData = \App\ProjectCategory::tree('', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                
                                <td><?php echo e($item->name); ?></td>
                                <td><?php echo e($item->slug); ?></td>
                                <td class="actions">
                                    <?php if(Auth::user()->can('edit-project_category')): ?>
                                        <a href="<?php echo e(action('Backend\ProjectController@showEditCategoryForm', array('id'=>$item->id))); ?>"
                                           class="on-default edit-row text-primary" data-toggle="tooltip"
                                           data-placement="top" title="" data-original-title="Edit"><i
                                                    class="fa fa-pencil"></i></a>
                                    <?php endif; ?>
                                    <?php if(Auth::user()->can('delete-project_category')): ?>
                                        <a href="javascript:;"
                                           class="on-default remove-row text-danger grid-btn-delete"
                                           data-placement="top" title="" data-original-title="Delete"
                                           data-toggle="modal" data-target=".modal-delete"
                                           data-href="<?php echo e(action('Backend\ProjectController@deleteCategory', array('id'=>$item->id))); ?>">
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            <?php if((!Auth::user()->can('add-project_category') and !Auth::user()->can('edit-project_category'))): ?>
            $('.col-form').remove();
            $('.col-grid').removeClass('col-lg-8').addClass('col-lg-12');
            <?php endif; ?>

            <?php if(Auth::user()->can('add-project_category') and $term->id <= 0): ?>
            $('.form-add').removeClass('d-none');
            $('.form-edit').remove();
            <?php endif; ?>

            <?php if(Auth::user()->can('edit-project_category') and $term->id > 0): ?>
            $('.form-add').remove();
