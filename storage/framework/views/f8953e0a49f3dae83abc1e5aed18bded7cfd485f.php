<?php $__env->startSection('title', 'Chuyên mục Tin tức'); ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\NewsController@category')); ?>" class="btn btn-default">
                        <i class="fa fa-plus"></i></a>
                </div>

                <h4 class="page-title">Chuyên mục Tin tức</h4>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-4 col-form">
                <div class="card-box">
                    ...
                    <form method="post" class="form-add d-none"
                          action="<?php echo e(action('Backend\NewsController@addCategory')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                ...
                                <?php $__currentLoopData = \App\NewsCategory::tree('', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <form method="post" class="form-edit d-none"
                          action="<?php echo e(action('Backend\NewsController@editCategory', array('id', $term->id))); ?>">
                        <?php echo e(csrf_field()); ?>
            ...
            <div class="col-lg-8 col-grid">
                <div class="card-box">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php $__currentLoopData = \App\NewsCategory::tree('', false); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="actions">
                                    <?php if(Auth::user()->can('edit-news_category')): ?>
                                        <a href="<?php echo e(action('Backend\NewsController@showEditCategoryForm', array('id'=>$item->id))); ?>"
                                    ...
                                    <?php if(Auth::user()->can('delete-news_category')): ?>
                                        <a href="javascript:;"
                                           ...
                                           data-href="<?php echo e(action('Backend\NewsController@deleteCategory', array('id'=>$item->id))); ?>">
