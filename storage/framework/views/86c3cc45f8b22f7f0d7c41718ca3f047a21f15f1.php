        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="<?php echo e(action('Backend\RoleController@showAddForm')); ?>" class="btn btn-default">
                        <i class="fa fa-plus"></i></a>
                </div>

                <h4 class="page-title">Danh sách roles</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(action('Backend\RoleController@index')); ?>">Danh sách roles</a>
                    </li>
                    <li class="breadcrumb-item active">Danh sách  [ <?php echo e(\Auth::user()->id); ?> ]</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-url="<?php echo e(action('Api\RoleController@grid')); ?>"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('click', function () {
                ...
                $.ajax({
                    url: '<?php echo e(action('Api\RoleController@delete')); ?>', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
