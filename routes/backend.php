...
Route::post('faqs/{id}','Backend\FaqsController@destroy')->middleware(['permission:list-faqs']);
/**About us**/
...
Route::post('aboutus/delete/{key}','Backend\AboutUsController@destroy')->middleware(['permission:list-aboutus']);
...
Route::post('contact/{id}','Backend\ContactUsController@destroy')->middleware(['permission:list-contact']);
...
Route::post('trainingcourse/delete/{id}', 'Backend\TrainingCourseController@destroy')->middleware(['permission:delete-trainingcourse']);

Route::get('tc/category', 'Backend\TrainingCourseController@category')->middleware(['permission:list-trainingcourse_category']);
Route::post('tc/category', 'Backend\TrainingCourseController@addCategory')->middleware(['permission:add-news_category']);;
...
Route::post('tc/category/edit/{id}', 'Backend\TrainingCourseController@editCategory')->middleware(['permission:edit-news_category']);;
Route::post('tc/category/delete/{id}', 'Backend\TrainingCourseController@deleteCategory')->middleware(['permission:delete-news_category']);
...
Route::post('jobsearch/{id}', 'Backend\JobSearchController@destroy')->middleware(['permission:delete-jobsearch']);

/* jobsearch Category */
Route::get('js/category', 'Backend\JobSearchController@category')->middleware(['permission:list-jobsearch_category']);
Route::post('js/category', 'Backend\JobSearchController@addCategory')->middleware(['permission:add-news_category']);;
Route::get('js/category/edit/{id}', 'Backend\JobSearchController@showEditCategoryForm')->middleware(['permission:list-news_category']);
Route::post('js/category/edit/{id}', 'Backend\JobSearchController@editCategory')->middleware(['permission:edit-news_category']);;
Route::post('js/category/delete/{id}', 'Backend\JobSearchController@deleteCategory')->middleware(['permission:delete-news_category']);
...
Route::post('news/delete/{id}', 'Backend\NewsController@deleteNew')->middleware(['permission:delete-news']);
...
Route::post('user/delete/{id}','Backend\UserController@deleteUser')->middleware(['permission:delete-user']);
