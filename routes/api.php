...
Route::get('comment/grid', 'Api\CommentController@grid');
...
//Route::get('jobsearch/searched', 'Fontend\JobSearchController@api');
...
Route::get('tourguide/grid', 'Api\TourGuideController@grid');
//Route::get('jobsearch/searched', 'Fontend\JobSearchController@api');
//Route::post('jobsearch/category/tree', 'Api\JobSearchController@treeCategory');

Route::post('tourguide/delete', 'Api\TourGuideController@destroy');

Route::get('js/category/tree', 'Api\JobSearchController@treeCategory');

Route::get('guidereview/loadmore','Api\GuidereviewController@loadmore');
