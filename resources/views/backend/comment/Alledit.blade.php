     ...
     <!--  <link href="backend/plugins/timepicker/bootstrap-timepicker.min.css" rel="stylesheet">
      ...
      <div class="container-fluid">
        ...
        <ul class="page-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{action('Backend\CommentController@showAllComment')}}">Comment</a></li>
            ...
            <div class="card-box">
              ...
              <hr>
               <div class="col-md-12">@include('backend.shared.flash-message')</div>
                 <form enctype= "multipart/form-data"  method="post" class="form-add" action="{{ action('Backend\CommentController@showEditAllCommentForm',['id' => $id_cmt ]) }}" >
                                       {{csrf_field()}}
                                  <div class="row">
                                      <div class="col-md-5">
