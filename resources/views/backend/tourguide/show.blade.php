            ...
            <div class="portfolioContainer ">
              <div class="row">
                <div class="col-sm-3 col-lg-3 col-md-3  ">
                  <div class=" thumb">
                    <img src="{{asset("images/cv/$img_cv")}}" class="thumb-img" alt="work-thumbnail">
                  </div>
                </div>
                <div class="col-sm-3 col-lg-3 col-md-3 ">
                  <div class=" thumb">

                    <img src="{{asset("images/cd/$img_cd")}}" class="thumb-img" alt="work-thumbnail">
                  </div>
                </div>

                <div class="col-sm-3 col-lg-3 col-md-3 ">
                  <div class="thumb">
                    <img src="{{asset("images/full/$img_full")}}" class="thumb-img" alt="work-thumbnail">
                  </div>
                </div>
              </div>
            </div>
