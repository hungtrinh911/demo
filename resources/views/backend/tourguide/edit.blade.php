                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row">
                        <div class="col-md-12">@include('backend.shared.flash-message')</div>
                              <div class="col-md-12">
                                    <form enctype= "multipart/form-data"  method="post" class="" action="{{ url('/backyard/TourGuide/edit/'. $tourguide->id) }}" >
                                        {{ csrf_field() }}
                                       <div class="row">
                                        <div class="col-md-5">
                                         <div class="form-group row">
                                          ...
                                          <div class="col-9">
                                           ...
                                           placeholder="" value="{{$tourguide->name}}" />
                                         </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-4 m-t-20" >
                                          <label for="">
                                            <input id="4" type="radio" class="hot_tourguide" name="hot_tourguide" value="0" required>
                                            Không
                                          </label>                                          
                                          <label for="">
                                    ...
                                    <div class="col-md-5">
                                      <div class="form-group row">
                                       ...
                                       <div class="input-group col-9">
                                        <input type="text" class="form-control" placeholder="mm/dd/yyyy" name="dob" id="datepicker-autoclose" value="{{$tourguide->dob}}">
                                    ...
                                    <div class=" form-group row m-t-20">
                                      ...
                                      @foreach(\App\TourGuide::orphanList() as $item)
                                     ...
                                     <input type="hidden" value="{{$img_cv = $tourguide->img_cv}}">
                                     <input type="hidden" value="{{$img_cd = $tourguide->img_cd}}">
                                     <input type="hidden" value="{{$img_full = $tourguide->img_full}}">
                                     <div class="row">
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-1" src="{{asset("images/cv/$img_cv")}}" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                                    ...
                                                    <div class="input-group-btn">
                                                      <div class="fileUpload btn btn-danger fake-shadow">
                                                        ...
                                                        <input id="logo-id-1" name="logo1" type="file" class="attachment_upload" value="{{$tourguide->img_cv}}">
                                                      </div>
                                                    </div>
                                                  </div>
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-2" src="{{asset("images/cd/$img_cd")}}" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                                    ...
                                                    <div class="input-group-btn">
                                                      <div class="fileUpload btn btn-danger fake-shadow">
                                                        ...
                                                        <input id="logo-id-2" name="logo2" type="file" class="attachment_upload" value="{{$tourguide->img_cd }}">
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-3" src="{{asset("images/full/$img_full")}}" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                                    ...
                                                    <div class="input-group-btn">
                                                      <div class="fileUpload btn btn-danger fake-shadow">
                                                        ...
                                                        <input id="logo-id-3" name="logo3" type="file" class="attachment_upload" value="{{$tourguide->img_full}}">
                                                      </div>
                                                    </div>
                                                  </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input type="text"   class="form-control"
                                                       id="people_id" name="people_id" placeholder="" value="{{$tourguide->people_id}}">
                                            </div>
                                        </div>
                                         <!-- <div class="form-group">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                  <input type="text" class="form-control" id="phone" name="phone" placeholder="" value="{{$tourguide->phone}}" />
                                                </div></label>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                  <select  class="selectpicker form-control" name="city" id="city">
                                                    <option value="{{$tourguide->city}}" class="">{{$tourguide->city}}</option>
                                     ...
                                     <div class="col-md-5">
                                      <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                              <input type="text" class="form-control" id="passpost" name="passpost" value="{{$tourguide->passpost}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                               <input type="email" class="form-control" id="email" name="email" required 
                                                     parsley-type="email" placeholder="Enter a valid e-mail" value="{{$tourguide->email}}" />
                                            </div>
                                        </div>
                                     </div>
                                     </div>
                                      <div class="row">
                                          <div class="col-md-10">
                                            ...
                                            <label for="" >Địa điểm chi tiết<span class="text-danger"></span></label>
                                                ...
                                                <textarea  class="form-control" id="address" name="address" value="{{$tourguide->address}}">{{$tourguide->address}}</textarea>
                                     ...
                                     <div class="row">
                                         <div class="col-md-5">
                                          <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                               <input type="text" class="form-control" id="LicensedType" name="LicensedType" value="{{$tourguide->LicensedType}}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                               <input type="text" class="form-control" id="card_id" name="card_id" value="{{$tourguide->card_id}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 row">
                                                ...
                                                <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" name="date_start" value="{{$tourguide->date_start}}">
                                                </div>
                                         ...
                                         <div class="col-md-5">
                                             ...
                                             <div class="form-group row">
                                                 ...
                                                 <select name="class" id="class" class="selectpicker form-control">
                                                     <option >{{$multilang->distinguished}}</option>
                                                     <option >{{$multilang->master}}</option>
                                                     <option >{{$multilang->licensed}}</option>
                                                     <option >{{$multilang->mate}}</option>
                                                 </select>
                                                 </div>
                                             </div>
                                             <div class="form-group row">
                                            ...
                                            <div class="col-9 row">
                                                    <input type="text" class="form-control col-md-9" placeholder="mm/dd/yyyy" id="datepicker1" class="datepicker1" name="join_date" value="{{$tourguide->join_date}}">
                                                    <div class="input-group-append col-md-3" >
                                                        <span class="input-group-text"><i class="md md-event-note"></i></span>
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 row">
                                              <input type="text" class="form-control col-md-9 datepicker2" placeholder="mm/dd/yyyy" id="datepicker2" name="date_end" value="{{$tourguide->date_end}}">
                                               <div class="input-group-append col-md-3" >
                                                        <span class="input-group-text"><i class="md md-event-note"></i></span>
                                              </div>          
                                            </div>
                                     ...
                                     <div class="row">
                                         <div class="col-md-10">
                                             <div class="form-group">
                                              ...
                                              <div>
                                                <textarea  class="form-control" id="info" name="info" value="">{{$tourguide->introduce}}</textarea>
                                              </div>
                                         </div>
                                     </div>  
                                     </div>                           
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function() {
              ...
              $( ".sex" ).each(function( index, element ) {
               ...
               var status_id = "{{$tourguide->status}}";
                if (status_id =='Tạm dừng') { status_id =0}
                  else status_id= 1;
              ...
              var hot_tourguide = "{{$tourguide->hot_tourguide}}";
