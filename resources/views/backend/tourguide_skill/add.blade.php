     ...
     <div class="profile-sidebar">
        <!-- PORTLET MAIN -->
                ...
                <div class="profile-userpic">
                  <img  src="{{asset("images/cv/$img_cv")}}" class="rounded-circle" alt="{{$tourguides->name}}">
                </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="checkbox checkbox-primary">
                            <input id="{{$lang1->id+100}}" class="lang" type="checkbox" name="languages[]" value="{{$lang1->id}}"  >
                            <label for="{{$lang1->id+100}}">
                             {{$lang1->language}} 
                           </label>
                         </div>
                         @endforeach 
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="checkbox checkbox-primary">
                          <input id="{{$lang2->id+100}}" class="lang" type="checkbox" name="languages[]" value="{{$lang2->id}}"  >
                          <label for="{{$lang2->id+100}}">
                           {{$lang2->language}} 
                         </label>
                       </div>
                       @endforeach                           
                 ...
                 <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Khác</label>
                      <div>
                        <textarea  class="form-control" id="langu" name="langu">{{ $tourguides->languages}}</textarea>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class=" card-box">
                     <div class="form-group">
                      ...
                      @foreach($tourguide_role1 as $role1)
                             <div class="checkbox checkbox-primary">
                              <input id="{{$role1->id +200}}" class="role" type="checkbox" name="roles[]" value="{{$role1->id}}"  >
                                <label for="{{$role1->id +200}}">
                                   {{$role1->name}} 
                                </label>
                             </div>
                      @endforeach 
                      ...
                      @foreach($tourguide_role2 as $role2)
                             <div class="checkbox checkbox-primary">
                              <input id="{{$role2->id +200}}" class="role" type="checkbox" name="roles[]" value="{{$role2->id}}"  >
                                <label for="{{$role2->id +200}}">
                                   {{$role2->name}} 
                                </label>
                             </div>
                      @endforeach                           
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                          @for ($i=0; $i < count($tourguide_fieldname) ; $i++) 
                                           <tr class="text-left">
                                              <td class="text-left">{{$tourguide_fieldname[$i]}}</td>
                                          @for ($j=0; $j < 5 ; $j++) 
                                              <td class="text-center">
                                                <div class="" style="position: relative;">
                                                  <input id="{{$tourguide_all_field[$i][$j]->id+500}}" class="field" type="checkbox" name="field[]" value="{{$tourguide_all_field[$i][$j]->id}}"  >
                                                </div>
                                              </td>
                                          @endfor
                                            </tr>   
             ...
             <!-- end -->
                     ...
                     <div class="form-group js-lang-check" id="js-lang-check">
                      ...
                      @foreach($tourguide_certificate1 as $certificate1)
                             <div class="checkbox checkbox-primary">
                              <input id="{{$certificate1->id +300}}" class="certificate" type="checkbox" name="certificates[]" value="{{$certificate1->id}}"  >
                                <label for="{{$certificate1->id +300}}">
                                   {{$certificate1->name}} 
                                </label>
                             </div>
                      @endforeach 
                      ...
                      @foreach($tourguide_certificate2 as $certificate2)
                             <div class="checkbox checkbox-primary">
                              <input id="{{$certificate2->id +300}}" class="certificate" type="checkbox" name="certificates[]" value="{{$certificate2->id}}"  >
                                <label for="{{$certificate2->id +300}}">
                                   {{$certificate2->name}} 
                                </label>
                             </div>
                      @endforeach                           
                      ...
                      <div class="col-md-12">
                          <div class="form-group">
                            <label >Khác</label>
                            <div>
                            <textarea  class="form-control" id="certi" name="certi">{{$tourguides->certificate }}</textarea>
                            </div>
                          </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr style="padding:10px 0 2px 0;">
                             <textarea name="locale_1" class="form-control" placeholder="Các địa điểm cách nhau bởi dấu chấm phẩy ">{{$tourguides->locale_1}}</textarea>
                          </div>
                            <div class="form-group">
                               <div>
                                     <button type="submit" class="btn btn-primary waves-effect waves-light" name="btn_role">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr>
                           <textarea name="locale_2" class="form-control"  placeholder="Các địa điểm cách nhau bởi dấu chấm phẩy ">{{$tourguides->locale_2}}</textarea>
                          </div>
                        </div> 
                     </div>
