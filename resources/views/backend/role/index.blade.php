        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="{{ action('Backend\RoleController@showAddForm') }}" class="btn btn-default">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ action('Backend\RoleController@index') }}">Danh sách roles</a>
                    </li>
                    <li class="breadcrumb-item active">Danh sách  [ {{\Auth::user()->id}} ]</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    {{--<i class="fa fa-times m-r-5"></i>Delete--}}
                    {{--</button>--}}
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('click', function () {
                ...
                $.ajax({
                    url: '{{ action('Api\RoleController@delete') }}', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
