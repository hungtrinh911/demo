...
@section('title', 'Cập nhật TrainingCourse')
@section('css')
...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ action('Backend\TrainingCourseController@index') }}">TrainingCourse</a></li>
        ...
        <form method="post" class="form-add"
              action="{{ action('Backend\TrainingCourseController@edit', array('id'=>$thing->id)) }}">
              {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    @foreach(\App\News::orphanListTrainingCourseEdit($thing->locale,true,'trainingcourse',$thing->id) as $item)
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                url: '{{ action('Api\TrainingCourseController@treeCategory') }}', type: 'GET', dataType: 'JSON',
