...
@section('title', 'Thêm Training Course')
@section('css')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add"
              action="{{ action('Backend\TrainingCourseController@add') }}">
             {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <textarea id="excerpt" name="excerpt" class="form-control" rows="3"
                                          placeholder="Tóm tắt">{{ old('excerpt') }}</textarea>
                            </div>
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group">
                            ...
                            <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                ...
                                @foreach(\App\News::orphanListTrainingCourse() as $item)
