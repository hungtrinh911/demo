...
@section('title', 'Cập nhật JobSeach')
@section('css')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add"
              action="{{ action('Backend\JobSearchController@edit', array('id'=>$thing->id)) }}">
              {{ csrf_field() }}
            <input type="hidden" id="id" name="id" value="{{ $thing->id }}">
            <input type="hidden" id="categories" name="categories" value="{{ $thing->categories }}">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select id="locale_source_id" name="locale_source_id" class="selectpicker show-tick"
                                    ...
                                    @foreach(\App\News::orphanListJobSearchEdit($thing->locale,true,'jobsearch',$thing->id) as $item)
                                ...
                                <label for="tags">Thành phố</label>
                                 <div class="form-group" id="tags">
                                        ...
                                        data-style="btn-white" name="tags_place" id="tags_place">
                                                    <option value="{{$thing->tags_place}}" class="">{{$thing->tags_place}}</option>
