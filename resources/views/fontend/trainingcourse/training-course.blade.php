                ...
                <div class="course-list d-flex">
                  ...
                  <div class="item">
                    <div class="item-info clearfix">
                      <h3>{{$item->title}}</h3>
                      <p>{{($item->excerpt)}}</p>
                      <a class="seemore" href="{{action('Fontend\TrainingCourseController@detail',$item->id)}}">{{$multilang->seemore}}</a>
                    </div>
                    <div class="item-img"><a href="{{action('Fontend\TrainingCourseController@detail',$item->id)}}"><img class="img-fluid" src="{{asset("$item->featured_img")}}" alt="{{$item->title}}"/></a></div>
                  </div>
                   @endforeach
