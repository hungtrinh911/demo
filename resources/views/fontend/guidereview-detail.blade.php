...
<meta name="keywords" content="jquery,rating,raty,voto,star,staring,classificacao,classificar,votar,plugin,javascript,library">
  ...
  <link href="{{asset("fontend/rate/demo/stylesheets/labs.css")}}" media="screen" rel="stylesheet" type="text/css">

<link rel="stylesheet" href="{{asset("fontend/rate/lib/jquery.raty.css")}}">
                ...
                <div class="share-thinking-content" id="divVote">
                  ...
                  <ul class="list-unstyled share-rate">
                    <li>
                      ...
                      <div id="score-callback1" class="score-callback" data-score="{{\App\TourGuide::getPoint(0,$id)}}"></div>
                    </li>
                    <li>
                      <p>Language / Foreign Language</p>
                      <div id="score-callback2" class="score-callback" data-score="{{\App\TourGuide::getPoint(1,$id)}}"></div>
                   </p>
                    </li>
                    <li>
                      <p>Work attitude & professionalism</p>
                      <div id="score-callback3" class="score-callback" data-score="{{\App\TourGuide::getPoint(2,$id)}}"></div>
                   </p>
                    </li>
                    <li>
                      <p>Facial, Facial & Personal Hygiene</p>
                      <div id="score-callback4" class="score-callback" data-score="{{\App\TourGuide::getPoint(3,$id)}}"></div>
                    </p>
                    </li>
                    <li>
                      <p>Knowledge</p>
                      <div id="score-callback5" class="score-callback" data-score="{{\App\TourGuide::getPoint(4,$id)}}"></div>
                   </p>
                    </li>
                    <li>
                      <p>Ability to solve problem</p>
                      <div id="score-callback6" class="score-callback" data-score="{{\App\TourGuide::getPoint(5,$id)}}"></div>
              ...
              <div class="collapse-body">
                <div class="tour-location-content">
                  <div class="select-location">
                    <p class="label-name" style="font-weight: 900; margin-bottom: 20px;">{{$multilang->locale_1}} :</p>
                    <a href="#tourlocation" class="show_hide js-location select2-hidden-accessible" data-content="toggle-text">...{{$multilang->seemore}}</a>
                  ...
                  <div class="select-location">
                    <p class="label-name" style="font-weight: 900 ; margin-bottom: 20px;">{{$multilang->locale_2}} :</p>
                     <a href="#tourlocation" class="show_hide2 js-location select2-hidden-accessible" data-content="toggle-text">...{{$multilang->seemore}}</a>
                    <div class="content2">
                       {!! $tourguide->locale_2 !!}
                    </div>
              ...
              <div class="collapse-body">
                <div class="comment-box-content">
                  <div class="cmt-list">
                    ...
                    <div class="item">
                      <div class="avatar" style="background-image: url('{{asset("fontend/images/comment-img.png")}}');"></div>
                      <div class="info">
                        <h4>{{$comment->name}}<small></small></h4>
                        <div class="comments">
                          <p>{{$comment->comment}}</p>
                        </div>
                      </div>
